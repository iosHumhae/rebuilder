...
$preview_id = !empty($_POST['preview_id']) ? $_POST['preview_id'] : '';
...
$rb_config_tables = "rb_config";
$config_search = "";
if(isset($preview_id)) {
    $rb_config_tables = "rb_preview_config";
    $config_search = " where co_id = '{$preview_id}' ";
}
...
if($mod_type == 1) { //환경설정
    ...
    $pr_title = !empty($_POST['pr_title']) ? $_POST['pr_title'] : '';
    $pr_desc = !empty($_POST['pr_desc']) ? $_POST['pr_desc'] : '';
}
