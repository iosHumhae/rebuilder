...
<?php
    ...
    add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/rb/rb.css/set.style.php?ver='.G5_SERVER_TIME.'&rb_color_set=' . urlencode($rb_core_colors) . '&rb_color_code=' . urlencode($rb_config_colors) . '&rb_is_index='.$index_css.'&rb_is_shop='.$shop_css.'&pr_id='.$preview_id.'" />', 0);
